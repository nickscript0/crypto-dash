...
var Agent = __webpack_require__(9);
...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (dash) {
            const prices = yield CoinMarketCap_1.getTickers();
...
function quadrigaDiffCoinMarketCap() {
    return __awaiter(this, void 0, void 0, function* () {
...
const big_js_1 = __webpack_require__(2);
function getPrices() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const [btc, ltc, eth, rai] = yield Promise.all([
            _getPrice(uBTC),
            _getPrice(uLTC),
            _getPrice(uETH),
            _getPrice(uRAI),
...
function _getPrice(url) {
    return __awaiter(this, void 0, void 0, function* () {
        return big_js_1.Big(JSON.parse((yield request(url)).text)[0].price_cad);
    });
}
function getTickers() {
    return __awaiter(this, void 0, void 0, function* () {
...
function _getTicker(url) {
    return __awaiter(this, void 0, void 0, function* () {
        return JSON.parse((yield request(url)).text)[0];
    });
}
...
function getCurrentBooks() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const [btc, eth, ltc, bch] = yield Promise.all([
            JSON.parse((yield request(REQ_TICKER + BTC_BOOK)).text),
            JSON.parse((yield request(REQ_TICKER + ETH_BOOK)).text),
            JSON.parse((yield request(REQ_TICKER + LTC_BOOK)).text),
            JSON.parse((yield request(REQ_TICKER + BCH_BOOK)).text),
        ]);
        return {
            btc,
            eth,
...
function getPrices() {
    return __awaiter(this, void 0, void 0, function* () {
        const res = yield getCurrentBooks();
        return {
            btc: big_js_1.Big(res.btc.last),
            eth: big_js_1.Big(res.eth.last),
            ltc: big_js_1.Big(res.ltc.last),
            bch: big_js_1.Big(res.bch.last),
        };
    });
}
exports.getPrices = getPrices;
